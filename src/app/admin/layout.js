  ...
  useEffect(() => {
    ...
    const fetchNotfication = async () => {
      try {
        ...
        // Handle notifications data if needed
      } catch (error) {
                        ...
                        <div className="hidden items-center space-x-5 xl:flex">
                          ...
                          <div className="relative">
                            <button
                              ...
                              className="relative flex h-[52px] w-[52px] items-center justify-center rounded-[12px] border border-purple-300 dark:border-darkblack-400"
                            >
                              <span className="absolute font-semibold  -right-[5px] -top-[2px] h-5 w-5 rounded-full text-white bg-red-500 ">
                                {notification.length}
                              </span>
                              <svg
                            ...
                            <div
                              id="notification"
                              className={`absolute right-0 z-10 mt-2 w-80 rounded-md border border-bgray-300 bg-white p-4 shadow-lg dark:border-darkblack-400 dark:bg-darkblack-500 ${
